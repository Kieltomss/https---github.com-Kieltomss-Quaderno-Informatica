...
<pre>
Questo esercizio genera una tabella che mostra i quadrati e i cubi dei numeri da 1 a un numero intero scelto dall'utente (da 1 a 10). 
L'utente seleziona il numero desiderato dal menu a tendina e, dopo aver inviato il modulo, la tabella viene generata dinamicamente.
</pre>

<h4>Ragionamento Logico:</h4>
<pre>
1. L'utente seleziona un numero da 1 a 10 tramite il menu a tendina.
2. Quando il modulo è inviato, il numero selezionato è recuperato tramite la variabile $_POST['valore'].
3. Un ciclo for viene usato per creare una tabella con il numero, il suo quadrato e il suo cubo.
4. La funzione pow() viene utilizzata per calcolare il quadrato e il cubo di ciascun numero.
5. La tabella viene creata dinamicamente per ogni numero da 1 fino al numero selezionato.
</pre>
